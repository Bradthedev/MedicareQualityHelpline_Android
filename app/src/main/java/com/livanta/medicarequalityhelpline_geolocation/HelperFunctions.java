...
public class HelperFunctions {
    ...
    public static ArrayList<HospitalResults> GetHospitalResultsArray(Cursor cursor){
        ArrayList<HospitalResults> results = new ArrayList<HospitalResults>();
        ...
        if(cursor.moveToFirst()) {
            ...
            do {
                ...
                results.add(i ,new HospitalResults(id, name, state, lat, lng));
